...
class Messages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en_US': {
          ...
          'ok': 'OK',
          'delete': 'Delete',
          'msgDelete': 'Delete Confirmation',
          'msgDeleteConfirm': 'data is removed if you delete.',
          'Nsec': '@N sec',
          'Nmin': '@N min',
        ...
        'ko_KR': {
          ...
          'ok': '확인',
          'delete': '삭제하기',
          'msgDelete': '정말 삭제하시겠습니까?',
          'msgDeleteConfirm': '삭제하면 기록들이 사라집니다.',
          'Nsec': '@N 초',
          'Nmin': '@N 분',
          'NhoursMmin': '@N 시간 @M 분',
